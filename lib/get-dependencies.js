          ...
          properties: {
            requireMore: {
              description: chalk.magenta(
                `Do you require any${
                  Object.keys(dependencies).length > 0 ? ' more' : ''
                } ${
                  dependencyType === 'prod' ? 'dependencies' : 'devDependencies'
                }? (y|n)`
              ),
              pattern: /(y|n)/,
            ...
            dependency: {
              description: chalk.magenta(
                `Please enter the ${
                  dependencyType === 'prod' ? 'dependency' : 'devDependency'
                } name`
              ),
            ...
            version: {
              description: chalk.magenta(
                'Please enter a the semantic version number'
              ),
